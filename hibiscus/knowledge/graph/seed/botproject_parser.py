"""
Botproject SQL Seed Parser
===========================
Parses botproject/seed/*.sql files into structured Python dicts
for ingestion into the Hibiscus Knowledge Graph.

Read-only — never modifies botproject files.
