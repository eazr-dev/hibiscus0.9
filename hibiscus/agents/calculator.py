...
Handles premium calculations, maturity projections, IRR,
inflation-adjusted values, and other insurance math.
Shows step-by-step working with all assumptions stated.
            ...
            llm_response = await call_llm(
                messages=[
                    {"role": "system", "content": self._system_prompt},
                    {
                        "role": "user",
                        "content": (
                            "You are EAZR's financial calculator. Show step-by-step working for "
                            "all calculations. State all assumptions. "
                            "Use Indian formats: ₹, lakhs/crores.\n\n"
