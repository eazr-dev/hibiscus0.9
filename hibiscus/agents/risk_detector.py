...
=============================
Mis-selling and coverage gap detector.

Identifies mis-selling patterns, coverage gaps, and risk flags
in user policies. Rates severity and provides evidence-based findings.
            ...
            llm_response = await call_llm(
                messages=[
                    {"role": "system", "content": self._system_prompt},
                    {
                        "role": "user",
                        "content": (
                            "You are EAZR's risk detector. Identify mis-selling patterns, "
                            "coverage gaps, and risk flags. Rate severity: "
                            "LOW/MEDIUM/HIGH/CRITICAL. Be specific and evidence-based.\n\n"
