...
Suggests appropriate insurance products based on user profile,
coverage gaps, and financial situation.
            ...
            llm_response = await call_llm(
                messages=[
                    {"role": "system", "content": self._system_prompt},
                    {
                        "role": "user",
                        "content": (
                            "You are EAZR's insurance recommender. Based on user profile, suggest "
                            "appropriate insurance products. Include IRDAI disclaimer. "
